...
CREATE TABLE `pais` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_PaisUsuarioModifica` (`idUsuarioModifica`),
  KEY `IX_Pais` (`id`),
...
INSERT INTO `pais` VALUES (1,'United States',1,NULL,'2024-05-13 07:02:59',NULL,1),(2,'United States',1,NULL,'2024-05-13 07:03:54',NULL,1);
...
-- Dump completed on 2024-05-14  0:26:12
